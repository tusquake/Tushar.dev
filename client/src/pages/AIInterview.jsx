...
const CUSTOM_INTERVIEWER_VOICES = [
    // --- India (IND) Accents ---
    { id: 'ind-girl-1', name: 'Ananya (Indian English - Girlish)', lang: 'en-IN', gender: 'girlish', pitch: 1.25, rate: 0.95, baseQuery: ['in', 'ananya', 'neerja', 'aria', 'google', 'microsoft'] },
    { id: 'ind-boy-1', name: 'Aarav (Indian English - Boyish)', lang: 'en-IN', gender: 'boyish', pitch: 1.15, rate: 0.98, baseQuery: ['in', 'aarav', 'google', 'microsoft'] },
    { id: 'ind-girl-2', name: 'Diya (Indian English - Friendly Girlish)', lang: 'en-IN', gender: 'girlish', pitch: 1.3, rate: 0.9, baseQuery: ['in', 'heera', 'google', 'microsoft'] },
    { id: 'ind-boy-2', name: 'Rohan (Indian English - Young Professional)', lang: 'en-IN', gender: 'boyish', pitch: 1.05, rate: 1.0, baseQuery: ['in', 'prabhat', 'google', 'microsoft'] },
    { id: 'ind-girl-3', name: 'Isha (Indian English - Conversational Girlish)', lang: 'en-IN', gender: 'girlish', pitch: 1.20, rate: 0.95, baseQuery: ['in', 'neerja', 'aria', 'google', 'microsoft'] },
    { id: 'ind-boy-3', name: 'Kabir (Indian English - Energetic)', lang: 'en-IN', gender: 'boyish', pitch: 1.10, rate: 1.05, baseQuery: ['in', 'prabhat', 'google', 'microsoft'] },

    // --- USA (USA) Accents ---
    { id: 'usa-girl-1', name: 'Aria (US English - Girlish)', lang: 'en-US', gender: 'girlish', pitch: 1.25, rate: 0.95, baseQuery: ['us', 'aria', 'samantha', 'zira', 'google', 'microsoft'] },
    { id: 'usa-boy-1', name: 'Tyler (US English - Boyish)', lang: 'en-US', gender: 'boyish', pitch: 1.18, rate: 1.0, baseQuery: ['us', 'guy', 'david', 'google', 'microsoft'] },
    { id: 'usa-girl-2', name: 'Chloe (US English - Playful Girlish)', lang: 'en-US', gender: 'girlish', pitch: 1.32, rate: 0.98, baseQuery: ['us', 'natural', 'samantha', 'google', 'microsoft'] },
    { id: 'usa-boy-2', name: 'Leo (US English - Junior Recruiter)', lang: 'en-US', gender: 'boyish', pitch: 1.08, rate: 1.02, baseQuery: ['us', 'natural', 'guy', 'david', 'google', 'microsoft'] },
    { id: 'usa-girl-3', name: 'Zoey (US English - Friendly Tech Lead)', lang: 'en-US', gender: 'girlish', pitch: 1.28, rate: 1.02, baseQuery: ['us', 'google', 'microsoft'] },
    { id: 'usa-boy-3', name: 'Ethan (US English - Bright Academic)', lang: 'en-US', gender: 'boyish', pitch: 1.12, rate: 0.96, baseQuery: ['us', 'google', 'microsoft'] },

    // --- United Kingdom (GBR) Accents ---
    { id: 'gbr-girl-1', name: 'Lily (UK English - Girlish)', lang: 'en-GB', gender: 'girlish', pitch: 1.28, rate: 0.92, baseQuery: ['gb', 'uk', 'hazel', 'google', 'microsoft'] },
    { id: 'gbr-boy-1', name: 'Oliver (UK English - Boyish)', lang: 'en-GB', gender: 'boyish', pitch: 1.14, rate: 0.95, baseQuery: ['gb', 'uk', 'daniel', 'google', 'microsoft'] },
    { id: 'gbr-girl-2', name: 'Mia (UK English - Soft-spoken Girlish)', lang: 'en-GB', gender: 'girlish', pitch: 1.22, rate: 0.90, baseQuery: ['gb', 'uk', 'hazel', 'google', 'microsoft'] },
    { id: 'gbr-boy-2', name: 'Harry (UK English - Friendly Peer)', lang: 'en-GB', gender: 'boyish', pitch: 1.08, rate: 0.98, baseQuery: ['gb', 'uk', 'daniel', 'google', 'microsoft'] },
    { id: 'gbr-girl-3', name: 'Amelia (UK English - Enthusiastic Girlish)', lang: 'en-GB', gender: 'girlish', pitch: 1.26, rate: 0.97, baseQuery: ['gb', 'uk', 'google', 'microsoft'] },
    { id: 'gbr-boy-3', name: 'Charlie (UK English - Conversational Boyish)', lang: 'en-GB', gender: 'boyish', pitch: 1.12, rate: 0.99, baseQuery: ['gb', 'uk', 'google', 'microsoft'] },

    // --- Australia (AUS) Accents ---
    { id: 'aus-girl-1', name: 'Matilda (Australian English - Girlish)', lang: 'en-AU', gender: 'girlish', pitch: 1.26, rate: 0.95, baseQuery: ['au', 'catherine', 'google', 'microsoft'] },
    { id: 'aus-boy-1', name: 'Liam (Australian English - Boyish)', lang: 'en-AU', gender: 'boyish', pitch: 1.16, rate: 1.02, baseQuery: ['au', 'google', 'microsoft'] },
    { id: 'aus-girl-2', name: 'Harper (Australian English - Cheerful Girlish)', lang: 'en-AU', gender: 'girlish', pitch: 1.30, rate: 0.98, baseQuery: ['au', 'google', 'microsoft'] },
    { id: 'aus-boy-2', name: 'Cooper (Australian English - Laidback)', lang: 'en-AU', gender: 'boyish', pitch: 1.06, rate: 0.97, baseQuery: ['au', 'google', 'microsoft'] },

    // --- Canada (CAN) Accents ---
    { id: 'can-girl-1', name: 'Sophia (Canadian English - Girlish)', lang: 'en-CA', gender: 'girlish', pitch: 1.24, rate: 0.94, baseQuery: ['ca', 'linda', 'google', 'microsoft'] },
    { id: 'can-boy-1', name: 'Owen (Canadian English - Boyish)', lang: 'en-CA', gender: 'boyish', pitch: 1.15, rate: 0.97, baseQuery: ['ca', 'google', 'microsoft'] },

    // --- Ireland (IRL) ---
    { id: 'irl-girl-1', name: 'Saoirse (Irish English - Friendly Girlish)', lang: 'en-IE', gender: 'girlish', pitch: 1.26, rate: 0.93, baseQuery: ['ie', 'irish', 'google', 'microsoft'] },
    { id: 'irl-boy-1', name: 'Connor (Irish English - Warm Boyish)', lang: 'en-IE', gender: 'boyish', pitch: 1.12, rate: 0.96, baseQuery: ['ie', 'irish', 'google', 'microsoft'] },

    // --- New Zealand (NZL) ---
    { id: 'nzl-girl-1', name: 'Kiwi (NZ English - Friendly Girlish)', lang: 'en-NZ', gender: 'girlish', pitch: 1.27, rate: 0.95, baseQuery: ['nz', 'google', 'microsoft'] },
    { id: 'nzl-boy-1', name: 'Finn (NZ English - Boyish)', lang: 'en-NZ', gender: 'boyish', pitch: 1.14, rate: 0.98, baseQuery: ['nz', 'google', 'microsoft'] },
];
...
const AIInterview = () => {
    ...
    const [selectedVoiceId, setSelectedVoiceId] = useState('ind-girl-1');
    ...
    const speak = (text, onEndCallback) => {
        ...
        if (activeVoice) {
            ...
            utter.lang = customVoice.lang;
        }

        utter.pitch = customVoice.pitch;
                                        ...
                                        >
                                            <span className="flex items-center gap-2">
                                                ...
                                                <span className="truncate">
                                                    {CUSTOM_INTERVIEWER_VOICES.find(cv => cv.id === selectedVoiceId)?.name || "Select Interviewer Voice"}
                                                </span>
                                            </span>
                                        ...
                                        {isVoiceDropdownOpen && (
                                            <>
                                                ...
                                                <div className="absolute left-0 right-0 mt-1.5 max-h-60 overflow-y-auto rounded-xl bg-white dark:bg-dark-900 border border-dark-200 dark:border-dark-800 shadow-2xl z-50 py-1">
                                                    {CUSTOM_INTERVIEWER_VOICES.map((v, idx) => {
                                                        const name = v.name;
                                                        ...
                                                        if (lang.includes('in')) {
                                                            ...
                                                            regionText = "Ireland";
                                                            flagIcon = (
                                                                <span className="w-5 h-3.5 flex items-center justify-center font-bold text-[8px] bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 rounded border border-indigo-500/20 px-1 py-0.5">
                                                                    IRL
                                                                </span>
                                                            );
                                                        } else if (lang.includes('nz')) {
                                                            regionText = "New Zealand";
                                                            flagIcon = (
                                                                <span className="w-5 h-3.5 flex items-center justify-center font-bold text-[8px] bg-pink-500/10 text-pink-600 dark:text-pink-400 rounded border border-pink-500/20 px-1 py-0.5">
                                                                    NZL
                                                                </span>
                                                            );
                                                        }
