...
const Footer = () => {
    ...
    const socialLinks = [
        ...
        {
            name: 'LinkedIn',
            url: 'https://www.linkedin.com/in/sethtushar111/',
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: 'Email',
            url: 'mailto:sethtushar111@gmail.com',
            icon: (
    ...
    return (
        <footer className="bg-dark-50 dark:bg-dark-900 border-t border-dark-100 dark:border-dark-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-3 text-dark-500 dark:text-dark-400">
                            <li className="flex items-center space-x-2">
                                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                                <span>sethtushar111@gmail.com</span>
                            </li>
                            <li className="flex items-center space-x-2">
                                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
