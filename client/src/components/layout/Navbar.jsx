                        ...
                        {isAuthenticated ? (
                            <div className="relative" id="profile-dropdown-container">
                                <button
                                    ...
                                    className="flex items-center gap-1.5 p-1 rounded-full hover:bg-dark-100 dark:hover:bg-dark-800 transition-all border border-transparent hover:border-dark-200/50 dark:hover:border-dark-750 focus:outline-none cursor-pointer"
                                    aria-expanded={profileDropdownOpen}
                                    aria-haspopup="true"
                                >
                                    <img
                                        src={user?.avatar || 'https://api.dicebear.com/7.x/bottts/svg?seed=samurai&backgroundColor=b6e3f4'}
                                        alt={user?.name || 'User Profile'}
                                        className="w-9 h-9 rounded-full bg-dark-200 dark:bg-dark-800 p-0.5 object-cover"
                                    />
                                    <svg className={`w-4 h-4 text-dark-500 transition-transform duration-200 ${profileDropdownOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" />
                                    </svg>
                                </button>
                                
                                {profileDropdownOpen && (
                                    <div className="absolute right-0 mt-2.5 w-60 rounded-2xl bg-white dark:bg-dark-900 border border-dark-200/50 dark:border-dark-800 shadow-2xl py-3.5 z-50 animate-fade-in">
                                        {/* User Info Header */}
                                        <div className="px-4 pb-3 mb-2 border-b border-dark-100 dark:border-dark-800">
                                            ...
                                            {user?.level && (
                                                <div className="flex items-center gap-1.5 mt-2">
                                                    <span className="bg-primary-500/10 text-primary-500 dark:bg-primary-500/20 dark:text-primary-400 border border-primary-500/20 px-1.5 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider">
                                                        Lvl {user.level}
                                                    </span>
                                        ...
                                        <div className="space-y-0.5 px-2">
                                            <Link 
                                                to="/profile" 
                                                className="flex items-center gap-2.5 px-3 py-2 text-sm text-dark-600 dark:text-dark-300 hover:bg-primary-50 dark:hover:bg-primary-900/20 hover:text-primary-600 dark:hover:text-primary-400 rounded-xl transition-all"
                                            >
                                        ...
                                        <div className="border-t border-dark-100 dark:border-dark-800 mt-2 pt-2 px-2">
                                            <button
                                                onClick={handleLogout}
                                                className="w-full flex items-center gap-2.5 px-3 py-2 text-sm text-red-600 hover:bg-red-500/10 dark:hover:bg-red-500/20 rounded-xl transition-all font-semibold cursor-pointer text-left"
                                            >
                    ...
                    <div className="pt-4 border-t border-dark-100 dark:border-dark-800 space-y-2">
                        {isAuthenticated ? (
                            <div className="space-y-1">
                                {/* Mobile User Summary */}
                                <div className="flex items-center gap-3 px-4 py-2.5 mb-2 rounded-xl bg-dark-50 dark:bg-dark-900/50 border border-dark-100 dark:border-dark-800">
                                    <img
                                        src={user?.avatar || 'https://api.dicebear.com/7.x/bottts/svg?seed=samurai&backgroundColor=b6e3f4'}
                                        alt={user?.name}
                                        className="w-10 h-10 rounded-full object-cover bg-dark-200 dark:bg-dark-800"
                                    />
                                ...
                                <Link
                                    to="/profile"
                                    className="flex items-center gap-2.5 px-4 py-3 rounded-lg font-medium text-dark-600 dark:text-dark-300 hover:bg-dark-50 dark:hover:bg-dark-800"
                                >
                                ...
                                <button
                                    onClick={handleLogout}
                                    className="w-full flex items-center justify-center gap-2 mt-2 py-2.5 px-4 text-sm font-bold text-red-600 hover:bg-red-500/10 dark:hover:bg-red-500/20 border border-red-500/20 rounded-xl transition-all cursor-pointer"
                                >
